...
def retreive_similar_docs_similarity_score_threshold(prompt: str, vector_db: Qdrant) -> str:
...
def main():
    ...
    # top k
    similarity_search_results_top_k = retreive_similar_docs_top_k(user_prompt, vector_db)    
